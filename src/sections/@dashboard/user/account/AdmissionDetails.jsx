   ...
   <Grid item xs={12} md={12}>
     <Card sx={{ p: 3 }}>
       ...
       >
         ...
         <RHFSelect name="Type of admission" label="Type of admission" placeholder="Board">
           <option value="" />
           {Type.map((option) => (
             <option key={option} value={option}>
               {option}
         ...
         <RHFTextField name="USN(University Seat Number)" label="USN(University Seat Number)" />
         <RHFTextField name="College ID Number" label="College ID Number" />
